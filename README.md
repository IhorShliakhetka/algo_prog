...
Опис задачі
Для заданого бінарного дерева необхідно знайти суму всіх листків, які є лівими дітьми свого батьківського вузла.
...
Реалізуйте функцію, яка отримує на вхід кореневий вузол дерева, та повертає 
значення суми `branchSums`:  
``` 
def branchSums(root): 
pass 
``` 
**Вхідні дані:** Дерево подається у вигляді вузлів, де кожен вузол має ціле 
значення. Корінь дерева завжди не є лівим листом 
